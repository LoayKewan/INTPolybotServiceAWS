...
def consume():
    while True:
        ...
        if 'Messages' in response:
            ...
            polybot_base_url = "http://loaybot.int-devops.click"


            # Combine the base URL and the endpoint to form the complete URL
            url = url = polybot_base_url + f"/results?predictionId={prediction_id}"
            ...
            prediction_summary = {
                ...
                'labels': labels,
                'time': current_time}
            data = {'prediction_id': prediction_summary['prediction_id'],'original_img_path': prediction_summary['original_img_path'],'predicted_img_path': prediction_summary['predicted_img_path'],'labels': prediction_summary['labels'],'time': prediction_summary['time']}
